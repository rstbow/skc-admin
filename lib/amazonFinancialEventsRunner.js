...
/**
 * Coerce a JS number into a clean value safe for SQL Decimal(18,4).
 *
 * JavaScript's float representation can produce values like
 * 0.28999999999999998 when you divide 29/100. When mssql serializes that
 * via toString() it sees 17 decimal places and throws "invalid scale"
 * against a Decimal(18,4) column.
 *
 * toFixed(4) forces a string with exactly 4 decimal places, then
 * parseFloat gives a cleanly-representable number.
 *   0.28999999999999998 -> "0.2900" -> 0.29
 */
